...
date: "Lafayette College Economics Seminar, October 30, 2023"
output:
...
- Since 2010 (that's when chess.com's data becomes available)
  ...
  - Also excluding small "border clashes", e.g., between India and Pakistan, China...
...
- Conflicts alter perception and foster identity: Akerlof and Kranton (2000, QJE), Caceres-Delpiano et. al. (2021, JPubE), Gehring (2022, EJ), Guo and An (JDev), among others.

- Emotional responses to "news": Sharkey and Shen (2021, PNAS): Mass shootings in the U.S.
...
- "Differences in Differences":
  - E.g., Ukrainian vs. Russian players before and after the war.
...
- Conflicts impact the quality of moves made by chess players, but no evidence for "aggressive" games played.
  - Good news!
- Impact is not uniform: Armenian-Azerbaijani conflict had a greater impact in magnitude.
  - Public support for the conflict? Russia consistently receives weak support.
- Players were resilient, played longer games and resigned less often post conflict.
  - Israel/Gaza conflict, smaller border conflicts between India and Pakistan, China.
---
