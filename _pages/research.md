...
permalink: /research/
title: Research
description: Job market paper, publications, and works in progress.
nav: true
nav_order: 2
---

<style>
  /* Hide the page title ("Research") and its description line;
     the section headings below organize the page instead. */
  .post-header {
    display: none;
  }
  .research-section {
...
<div class="research-section">
  ...
  <div class="paper">
    ...
    <div class="paper-abstract">
      <strong>Abstract.</strong> This paper studies whether emotionally salient events affect physician decision-making and maternal health during childbirth using evidence from NCAA football games. We document three main findings. First, the probability of a non-cesarean, non-induced birth occurring around NCAA game days increases, consistent with deliveries being shifted around games. Second, the probability of maternal complications increases by 0.23 percentage points on game weekends, which is a 19 percent increase relative to the baseline rate. Third, these effects are concentrated among low-SES, uninsured, and WIC mothers, while we find little evidence of differences by race. The results suggest that salient events such as NCAA football games, particularly those played on weekends when staffing is typically low, can influence physician behavior and worsen maternal outcomes.
    </div>
  </div>
  <div class="paper">
